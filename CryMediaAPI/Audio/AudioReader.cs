...
public class AudioReader : MediaReader<AudioFrame, AudioWriter>, IDisposable
{
    ...
    public async Task LoadMetadataAsync(bool ignoreStreamErrors = false)
    {
        ...
        try
        {
            var metadata = await JsonSerializer.DeserializeAsync(r, SourceGenerationContext.Default.AudioMetadata);
            ...
            try
            {
                ...
                if (audioStream != null)
                {
                    ...
                    metadata.BitDepth = (int)audioStream.BitsPerSample.Value;
